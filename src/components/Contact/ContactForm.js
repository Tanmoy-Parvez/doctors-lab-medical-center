                ...
                <div className="col-md-6 col-12 pb-5 mb-5 animate__animated animate__lightSpeedInRight">
                    <div className="d-flex row">
                        <div className="col-md-6 col-12 mb-2 mt-2">
                            <input type="text" className="form-control me-5 bg-light py-3 shadow-lg border-0" placeholder="Your Name" />
                        </div>
                        <div className="col-md-6 col-12 mt-2">
                            <input type="text" className="form-control bg-light py-3 shadow-lg border-0" placeholder="Your Email" />
                        </div>
                    </div>

                    <input type="text" className="form-control my-3 bg-light py-3 shadow-lg border-0" placeholder="Your Address" />
                    <input type="text" className="form-control my-3 bg-light py-3 shadow-lg border-0" placeholder="Subject" />
                    <textarea className="form-control bg-light py-3 h-50 shadow-lg border-0" placeholder="Enter Your Message" ></textarea>
                    <button className="regular-btn shadow-lg border-0 mb-5 mt-3 d-flex align-items-center">Send Message  <i className="fas fa-arrow-alt-circle-right fs-2 ms-2"></i></button>
                </div>
            </div>
        </div>
    );
